...
ActiveRecord::Schema.define(version: 2019_11_14_132426) do
  ...
  create_table "pic_posts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_pic_posts_on_user_id"
  end
  ...
  create_table "requests", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "pending_friend_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["pending_friend_id"], name: "index_requests_on_pending_friend_id"
